import { AuthenClient, AuthenService, OAuth2Client, OAuth2Service, PrivilegesClient, PrivilegesService, User } from "authen-client"
...
class ApplicationContext {
  ...
  constructor() {
    ...
    this.getPrivilegesService = this.getPrivilegesService.bind(this)
  ...
  getPrivilegesService(): PrivilegesService {
    if (!this.privilegesService) {
      const c = this.getConfig()
      this.privilegesService = new PrivilegesClient(httpRequest, c.my_privileges_url)
    }
...
export function getPrivilegesService(): PrivilegesService {
  return context.getPrivilegesService()
}
