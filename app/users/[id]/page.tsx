    ...
    <div className="view-container">
      <form id="userForm" name="userForm" model-name="user" ref={refForm as any}>
        <header>
          ...
          <h2>
            {flag.newMode ? resource.create : resource.edit} {resource.user}
          </h2>
        </header>
        <div className="row">
          ...
          <label className="col s12 m6 flying">
            ...
            <select id="title" name="title" value={user.title || ""} data-value onChange={(e) => updateTitle(e.target, state.user, setState)}>
